...
Arch Event Observer is part of the Arch library ecosystem.

This repository owns event and result observation APIs. Ecosystem-level standards and shared
samples live in Arch Toolkit.
